...
{
    private readonly IpfsContext ipfs = TestFixture.IpfsContext;
    ...
    public async Task Stat()
    {
        ...
        var node1 = await this.ipfs.Object.PutAsync(data1,
            new[] { node2.ToLink("some-link") });
        var info = await this.ipfs.Object.StatAsync(node1.Id);
